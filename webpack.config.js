    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                title: 'GaiaMod - Editor', ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['playground'], template: 'src/playground/index.ejs', filename: 'playground.html',
                title: 'GaiaMod - Playground', ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['player'], template: 'src/playground/index.ejs', filename: 'index.html',
                title: 'GaiaMod - A mod of PenguinMod', ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
            ...
            new HtmlWebpackPlugin({
                ...
                title: 'Embedded Project - GaiaMod', noTheme: true, ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['addon-settings'], template: 'src/playground/simple.ejs', filename: 'addons.html',
                title: 'Addon Settings - GaiaMod', ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['credits'], template: 'src/playground/simple.ejs', filename: 'credits.html',
                title: 'GaiaMod, PenguinMod & TurboWarp Credits', noSplash: true, ...htmlWebpackPluginCommon
            }),
