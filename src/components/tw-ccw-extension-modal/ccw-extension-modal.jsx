...
const messages = defineMessages({
    ...
    description: {
        defaultMessage: 'Load extensions from Cocrea World, available at https://assets.ccw.site/extensions.',
