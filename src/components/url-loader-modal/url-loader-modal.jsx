...
const messages = defineMessages({
    title: {
        defaultMessage: 'Load from other Scratch Mods',
        description: 'Title for the Scratch Mod loader modal',
        id: 'gui.urlLoader.title'
    },
    titlePM: {
        defaultMessage: 'Load from PenguinMod',
        description: 'Title for the PenguinMod loader modal',
        id: 'gui.urlLoader.titlePM'
    },
    titleDB: {
        defaultMessage: 'Load from DashBlocks',
        description: 'Title for the DashBlocks loader modal',
        id: 'gui.urlLoader.titleDB'
    },
    urlPlaceholder: {
    ...
    urlExamplePM: {
        defaultMessage: 'https://studio.penguinmod.com/#4268519316',
        description: 'Example URL for PenguinMod projects',
        id: 'gui.urlLoader.urlExamplePM'
    },
	urlExampleDB: {
        defaultMessage: 'https://dashblocks.org/#489',
        description: 'Example URL for DashBlocks projects',
        id: 'gui.urlLoader.urlExampleDB'
    },
    openButton: {
        defaultMessage: 'Open',
                        ...
                        <ul className={styles.examplesList}>
                            <li className={styles.exampleItem}>
                                <FormattedMessage
                                    ...
                                    {...messages.urlExamplePM}
                                    {...messages.urlExampleDB}
                                />
                            </li>
                        </ul>
                    </Box>
