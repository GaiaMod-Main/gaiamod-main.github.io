export default async function ({ addon, console }) {
  ...
  const loadExtensions = () => {
    ...
    const EXTENSIONS = ["music", "pen", "text2speech", "translate", "appmaker", "croquet", "chatgpt2scratch", "ml2scratch", "tm2scratch", "tmpose2scratch",                    "handpose2scratch", "posenet2scratch", "facemesh2scratch", "ic2scratch", "scratch2webserialapi"];
